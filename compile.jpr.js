...
var repl = ((function  () {
    ...
    var rl_g469;
    return ((((rl_g469 = (((require(("readline"))).createInterface)((list2obj((list((list(("input"), (process.stdin))), (list(("output"), (process.stdout)))))))))), ((rl_g469.setPrompt)(("¿ "))), ((rl_g469.prompt)()), ((rl_g469.on)(("line"), (function  (line) {
    return (((prn((cmd_handler(line)))), ((rl_g469.prompt)())))
}))))))
}))
})());
var start = ((function  () {
...
((function  () {
    var fs_g474;
    return (((fs_g474 = (require(("fs")))), (gather_callbacks((map((function  (file) {
    return (((function  (f) {
    return ((((fs_g474.readFile)(file, (function  (err, data) {
    var g_g470_g475;
    return (((((g_g470_g475 = err), (((alist(g_g470_g475)) && ((g_g470_g475.length) === 0)) ? false : ((g_g470_g475 === 0) ? true : g_g470_g475))) ? (prn(err)) : (parse(data, f)))))
})))))
})))
}), (cat((list((str(__dirname, ("/jasper.jpr"))))), files)))), (function  (codes) {
    var g_g472_g476, g_g471_g477, output_g478, code_g479, g_g473_g480;
    return (((prn(((now()) - start))), ((code_g479 = (apply(cat, codes))), ((output_g478 = (compile(code_g479))), ((((g_g471_g477 = (((g_g472_g476 = run_repl), (((alist(g_g472_g476)) && ((g_g472_g476.length) === 0)) ? false : ((g_g472_g476 === 0) ? true : g_g472_g476))) ? false : true)), (((alist(g_g471_g477)) && ((g_g471_g477.length) === 0)) ? false : ((g_g471_g477 === 0) ? true : g_g471_g477))) ? ((fs_g474.writeFileSync)((str((files[((files.length) - 1)]), (".js"))), output_g478)) : null)))), (prn(((now()) - start))), (((g_g473_g480 = run_repl), (((alist(g_g473_g480)) && ((g_g473_g480.length) === 0)) ? false : ((g_g473_g480 === 0) ? true : g_g473_g480))) ? (repl()) : null)))
})))))
})());
